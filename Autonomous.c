...
#pragma config(Motor,  port2,           rightMotor1,   tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port3,           frontflipMotor, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           rightMotor2,   tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port5,            ,             tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           leftMotor1,    tmotorVex393_MC29, PIDControl, encoderPort, I2C_3)
#pragma config(Motor,  port7,           leftMotor2,    tmotorVex393_MC29, openLoop, encoderPort, I2C_4)
#pragma config(Motor,  port8,           rearflipMotor, tmotorVex393_MC29, PIDControl, encoderPort, I2C_5)
...
void fliplow()
{
	...
	setMotorTarget(rearflipMotor, (-80*627)/360, 70, false);

	while (!getMotorTargetCompleted(rearflipMotor))
		wait1Msec(10);
...
void flipball()
{
	...
	setMotorTarget(rearflipMotor, (-70*627)/360, 70, false);
...
void flipup()
{
	...
	setMotorTarget(rearflipMotor, 0, 127, false);
...
void flipdown()
{
	...
	setMotorTarget(rearflipMotor, (-100*627)/360, 80, false);
...
void pre_auton()
{
	...
	bLCDBacklight = true;
	resetMotorEncoder(rearflipMotor);
	resetMotorEncoder(frontflipMotor);
...
task autonomous()
{
	...
	case 1:
		...
		spin(-105, 127, false); //turns 90 degrees to the right
...
task usercontrol()
{
	...
	nMotorPIDSpeedCtrl[rearflipMotor] = RegIdle;
	...
	while(1 == 1)
	{
		...
		{
			motor[frontflipMotor] = 127;
		}
		else if(vexRT[Btn6DXmtr2] == 1)
		{
			motor[frontflipMotor] = -40;
		}
		else
		{
			motor[frontflipMotor] = 0;
		}

		//Flipper Control
		if (vexRT[Btn5UXmtr2] == 1)
		{
			motor[rearflipMotor] = 127;
		}
		else if (vexRT[Btn5DXmtr2] == 1)
		{
			motor[rearflipMotor] = -50;
		}
		else
		{
			motor[rearflipMotor] = 0;
		}
