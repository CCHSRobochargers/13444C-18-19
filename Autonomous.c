...
#pragma config(Motor,  port3,           leftMotor1,    tmotorVex393_MC29, PIDControl, encoderPort, I2C_6)
#pragma config(Motor,  port4,           rightMotor2,   tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_3)
#pragma config(Motor,  port5,           leftMotor2,    tmotorVex393_MC29, openLoop, encoderPort, I2C_5)
#pragma config(Motor,  port6,           liftMotor,     tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port7,           wristMotor,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           flipMotor,     tmotorVex393_MC29, PIDControl, encoderPort, I2C_2)
...
void flipup()
{
	...
	moveMotorTarget(flipMotor, 100, 127, false);
...
void flipdown()
{
	...
	moveMotorTarget(flipMotor, -100, 80, false);
}
