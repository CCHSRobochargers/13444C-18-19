...
void fliplow()
{
	...
	setMotorTarget(flipMotor, (-110*627)/360, 80, false);
...
void flipdown()
{
	...
	setMotorTarget(flipMotor, (-160*627)/360, 80, false);
...
task autonomous()
{
	...
	case 1:
		...
		move(-37, 127, false); //goes forward to the cap

		move(12, 127, false); //goes backward to avoid ball

		spin(-90, 127, false); //turns 90 degrees to the right

		flipup();

		wait1Msec(1000); // waits for 1000 milliseconds

		move(-20, 127, false); //goes onto platform
